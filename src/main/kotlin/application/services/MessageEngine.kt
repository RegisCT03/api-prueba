...
/**
 * Motor de mensajes personalizados.
 * Cruza el ROL del usuario con el COLOR del semáforo para generar
 * la recomendación específica de la matriz de contenido.
 *
 * Matriz:
 *  ┌──────────────────┬─────────┬───────────────────────────────────────────────────────────────┐
 *  │ Rol              │ Color   │ Mensaje                                                       │
 *  ├──────────────────┼─────────┼───────────────────────────────────────────────────────────────┤
 *  │ Trabajador       │ Verde   │ Óptimo: Día ideal para trabajo profundo...                    │
 *  │ Trabajador       │ Amarillo│ Precaución: Tu energía va en descenso...                     │
 *  │ Trabajador       │ Rojo    │ Crítico: Riesgo de errores laborales...                      │
 *  │ Estudiante       │ Verde   │ Óptimo: ¡Energía a tope!...                                  │
 *  │ Estudiante       │ Amarillo│ Precaución: Tu capacidad de retención está bajando...         │
 *  │ Estudiante       │ Rojo    │ Crítico: Estudiar así es contraproducente...                  │
 *  │ Estudia y Trabaja│ Verde   │ Óptimo: Tienes el combustible necesario...                   │
 *  │ Estudia y Trabaja│ Amarillo│ Precaución: El cansancio se acumula rápido...                │
 *  │ Estudia y Trabaja│ Rojo    │ Crítico: Alerta de Burnout...                                │
 *  └──────────────────┴─────────┴───────────────────────────────────────────────────────────────┘
 */
object MessageEngine {

    // IDs de rol alineados con el seed (02_seed.sql)
    // id=1 Trabajador, id=2 Estudiante, id=3 Estudia y Trabaja
    ...
    data class MessageResult(
        ...
        val body: String,         // texto principal del mensaje
    ...
    /**
     * Devuelve el mensaje personalizado según rol y color de semáforo.
     *
     * @param idRol       ID del rol del usuario (1, 2 o 3). null = mensaje genérico.
     * @param semaphoreColor  "GREEN", "YELLOW" o "RED"
     * @param batteryLevel    0-100 (para calcular el rango en la respuesta)
     */
    fun getMessage(
        idRol: Int?,
        ...
        return when {
            ...
            // ── FALLBACK (rol desconocido — usa mensaje genérico del semáforo) ─
